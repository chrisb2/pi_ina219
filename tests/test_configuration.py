...
class TestConfiguration(unittest.TestCase):
    ...
    def test_calibration_register_maximum_is_fffe_1_ohm(self, device):
        ...
        calls = [call(0x40, 0x05, [0xFF, 0xFE]), call(0x40, 0x00, [0x01, 0x9f])]
        self.ina._i2c.write_i2c_block_data.assert_has_calls(calls)
    ...
    def test_auto_gain_with_expected_amps(self):
        ...
        calls = [call(0x40, 0x05, [0x83, 0x33]), call(0x40, 0x00, [0x09, 0x9f])]
        self.ina._i2c.write_i2c_block_data.assert_has_calls(calls)
    ...
    def test_auto_gain_no_expected_amps(self, device):
        ...
        self.assertTrue(self.ina._auto_gain_enabled)
        calls = [call(0x40, 0x05, [0x83, 0x33]), call(0x40, 0x00, [0x01, 0x9f])]
        self.ina._i2c.write_i2c_block_data.assert_has_calls(calls)
    ...
    def test_32v_40mv_9bit(self):
        ...
        calls = [call(0x40, 0x05, [0x83, 0x33]), call(0x40, 0x00, [0x20, 0x07])]
        self.ina._i2c.write_i2c_block_data.assert_has_calls(calls)
    ...
    def test_32v_40mv_10_bit_11_bit(self):
        ...
        calls = [call(0x40, 0x05, [0x83, 0x33]), call(0x40, 0x00, [0x20, 0x97])]
        self.ina._i2c.write_i2c_block_data.assert_has_calls(calls)
    ...
    def test_32v_40mv_2_samples_128_samples(self):
        ...
        calls = [call(0x40, 0x05, [0x83, 0x33]), call(0x40, 0x00, [0x24, 0xff])]
        self.ina._i2c.write_i2c_block_data.assert_has_calls(calls)
    ...
    def test_32v_40mv_4_samples_8_samples(self):
        ...
        calls = [call(0x40, 0x05, [0x83, 0x33]), call(0x40, 0x00, [0x25, 0x5f])]
        self.ina._i2c.write_i2c_block_data.assert_has_calls(calls)
    ...
    def test_32v_40mv_8_samples_16_samples(self):
        ...
        calls = [call(0x40, 0x05, [0x83, 0x33]), call(0x40, 0x00, [0x25, 0xe7])]
        self.ina._i2c.write_i2c_block_data.assert_has_calls(calls)
    ...
    def test_32v_40mv_32_samples_64_samples(self):
        ...
        calls = [call(0x40, 0x05, [0x83, 0x33]), call(0x40, 0x00, [0x26, 0xf7])]
        self.ina._i2c.write_i2c_block_data.assert_has_calls(calls)
    ...
    def test_sleep(self):
        ...
        self.ina.sleep()
        self.ina._i2c.write_i2c_block_data.assert_called_with(0x40, 0x00, [0x00, 0x08])

    def test_wake(self):
        self.ina._i2c.read_word_data = Mock(return_value=0x8)
        self.ina.wake()
        self.ina._i2c.write_i2c_block_data.assert_called_with(0x40, 0x00, [0x00, 0xf])

    def test_reset(self):
        self.ina.reset()
        self.ina._i2c.write_i2c_block_data.assert_called_with(0x40, 0x00, [0x80, 0x00])
